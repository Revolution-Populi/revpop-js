...
ChainTypes.operations = {
    ...
    ticket_create: 57,
    ticket_update: 58,
    personal_data_create: 59,
    personal_data_remove: 60,
    content_card_create: 61,
    content_card_update: 62,
    content_card_remove: 63,
    permission_create: 64,
    permission_remove: 65,
    content_vote_create: 66,
    content_vote_remove: 67
};
