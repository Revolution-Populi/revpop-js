...
ChainTypes.operations = {
    ...
    htlc_extend: 52,
    htlc_refund: 53,
    personal_data_create: 54,
    personal_data_remove: 55,
    content_card_create: 56,
    content_card_update: 57,
    content_card_remove: 58,
    permission_create: 59,
    permission_remove: 60,
    content_vote_create: 61,
    content_vote_remove: 62
};
