...
ChainTypes.operations = {
    ...
    commit_create_v3: 61,
    reveal_create_v3: 62,
    limit_order_create: 63,
    limit_order_cancel: 64,
    call_order_update: 65,
    fill_order: 66,
    worker_create: 67,
    bid_collateral: 68,
    execute_bid: 69,
    ...
    htlc_extend: 73,
    htlc_refund: 74,
    liquidity_pool_create: 75,
    liquidity_pool_delete: 76,
    liquidity_pool_deposit: 77,
    liquidity_pool_withdraw: 78,
    liquidity_pool_exchange: 79
};
