...
class PersonalData {
    ...
    toBuffer() {
        return Buffer.from(this.stringify(), 'utf-8');
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    assign(props) {
        this.setFirstName(props.first_name);
        this.setLastName(props.last_name);
        this.setMiddleName(props.middle_name);
        this.setNameTitle(props.name_title);
